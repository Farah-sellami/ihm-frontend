        ...
        <Container className="flex items-center justify-between md:flex-row flex-col">
          <div className="w-full md:w-1/2 text-white pr-12">
            ...
            <div className="flex items-center gap-8 my-8">
              ...
              <div className="border border-[#20354c] bg-white text-[#20354c] rounded-xl p-4 text-center">
                <Title level={4} className="text-[#20354c]">
                  54
                </Title>
                <Body className="leading-7 text-[#20354c]">Total Product</Body>
              </div>
              <div className="border border-[#20354c] bg-white text-[#20354c] rounded-xl p-4 text-center">
                <Title level={4} className="text-[#20354c]">842M</Title>
                <Body className="leading-7 text-[#20354c]">Total Auction</Body>
              </div>
              ...
              <div className="border border-[#20354c] bg-white text-[#20354c] rounded-xl p-4 text-center">
                ...
                <Body className="leading-7 text-[#20354c]">Total Category</Body>
              </div>
            </div>
          </div>
