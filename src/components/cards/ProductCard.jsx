      ...
      <div className="bg-white shadow-s1 rounded-xl p-3">
        ...
        <div className="details mt-4">
          ...
          <div className="flex items-center  justify-between mt-3">
            <SecondaryButton className="rounded-lg text-sm">Place Bid</SecondaryButton>
            <SecondaryButton className="border border-[#D47400] rounded-lg px-4 py-3 bg-transparent hover:bg-[#FBF1E5] transition-colors duration-200">
